...
{ type: 'teacher', desc: `В 3 классе мы с подругой после продлёнки рванули в кабинет ИЗО — рисовать. Увлеклись так, что прозевали, как школа опустела и закрылась. Родители, не дождавшись нас, уже звонили по всем номерам: в школу, одноклассникам, учителям. Охранник уверял, что в здании ни души. От отчаяния они заявили в милицию. А нас в итоге нашли там же — за нашими «шедеврами». Дома ждали горячие объятия... и не менее горячие выговоры. 😄`, images: ['img1_1','img1_2','img1_3'], options: ['Татьяна Шаталова - математика','Елена Генджер - наставница', 'Валентина Третьякова - география','Полионова Анна - наставница'], answer: 1,},
  ...
  {type: 'teacher', desc: `Пела 9 лет в хоре и играла на домре. Любила математику и терпеть не могла физкультуру.`, images: ['img4_1'], options: ['Марина Хазова', 'Полионова Анна','Анна Цепляева','Анна Разумова'], answer: 1,},
