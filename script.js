...
{ type: 'teacher', desc: `В 3 классе мы с подругой после продлёнки рванули в кабинет ИЗО — рисовать. Увлеклись так, что прозевали, как школа опустела и закрылась. Родители, не дождавшись нас, уже звонили по всем номерам: в школу, одноклассникам, учителям. Охранник уверял, что в здании ни души. От отчаяния они заявили в милицию. А нас в итоге нашли там же — за нашими «шедеврами». Дома ждали горячие объятия... и не менее горячие выговоры. 😄`, images: ['img1_1','img1_2','img1_3'], options: ['Татьяна Шаталова','Елена Генджер', 'Валентина Третьякова','Полионова Анна'], answer: 1,},
  ...
  {type: 'student', desc: `В один момент, резко по обстоятельствам интересных активностей от школы был придуман дуэт и два костюма. В которых этот дуэт было видно хоть из далека и привлекал внимание. А после дуэт частично появился в ролике на канале школы. На фотографиях будет части образа только одного человека из дуэта.`, images: ['artem1','artem2'], options: ['Алексей Морозов', 'Артемий Добрусин','Маруся Маркина','Ева Рогозина'], answer: 1,},
